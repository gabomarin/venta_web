					...
					if(isset($_REQUEST['nombre']) && isset($_REQUEST['mail']) && isset($_REQUEST['descripcion']))
					{
						...
						if(mail($para, $titulo, $mensaje, $cabeceras)) {  // Si fue envieado entonces tambien se manda un correo de respuesta temporal al usuario
						   ...
						   //echo $count+"  saasdasd";
							...
							$msg.= '<div class="hero-unit span5">';
							$msg.= '<a href=http://alanturing.cucei.udg.mx/cc409/virtualtd/index.php><img class="img-rounded" src="images/logo_mail.jpg"  /></a>';
							$msg.= '<p class="hero-unit">Gracias por utilizar nuestro formulario de contacto, revisaremos tu solicitud y te responderemos lo mas rapido posible</p>';
							$msg.= '</div>';
